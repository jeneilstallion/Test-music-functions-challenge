...
print(search_by_artist(my_songs, "Bilal"))
...
print('QUESTION 2\n')
print(search_by_title(my_songs, "Killing Me Softly"))
...
print('QUESTION 3\n')
print(play_shuffle(my_music))

print(display_playlist(my_music))
...
print(remove_song(my_music, 'Killing Me Softly', 'Fugees'))
